...
Enter a component version matching the current DSH version in the plugin installer. For DSH `0.1.7-rc.2`, enter `@deepseek-ai/dsh-subagent-codex@0.1.7-rc.2`, or run:
