...
![DeepSeek Harness 的 Codex 订阅设置](https://cdn.jsdelivr.net/gh/WSL043/dsh-codex-subscription@main/docs/assets/settings.png)
...
![输入框内的 Codex 剩余额度](https://cdn.jsdelivr.net/gh/WSL043/dsh-codex-subscription@main/docs/assets/composer-quota-en.png)
