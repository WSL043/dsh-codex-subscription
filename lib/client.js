...
`;
		...
		const zh = {
			...
			imageModelHint: "订阅端未报告实际型号。2.5 参数为实验选项，出图成功不代表已按指定型号或质量执行。",
			sketchTool_pen: "画笔",
		...
		const en = {
			...
			imageModelHint: "The subscription endpoint has not reported the actual model. Image 2.5 parameters are experimental; successful generation does not confirm the requested model or quality was used.",
			sketchTool_pen: "Pen",
