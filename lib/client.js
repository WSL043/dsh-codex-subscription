		...
		*/
		...
		function CodexComposerQuota({ preference, rpc, t, directory }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				onClick: () => setOpen((value) => !value),
				children: [quotas.slice(0, 2).map((quota, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: "codexQuotaCompactWindow",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
						shortWindow(quota.windowSeconds, t),
						" ",
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: [percent(quota.remainingPercent), "%"] })
					] }), preferenceSnapshot.quickQuotaMode === "bar" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("progress", {
						className: "codexQuotaUnderline",
						max: 100,
						value: quota.remainingPercent,
						"aria-hidden": "true"
					}) : null]
				}, `${quota.windowSeconds}-${index}`)), quotas.length > 2 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["+", quotas.length - 2] }) : null]
