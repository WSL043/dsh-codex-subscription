...
`;
		...
		function SketchWorkspace({ preference, attachSketch, appendPrompt, registerOpen, t }) {
			...
			(0, react.useEffect)(() => registerOpen((mode = "sketch", source = document.activeElement) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SketchStudio, {
				open,
				onClose: () => {
					setOpen(false);
		...
		function ImageWorkspace(props) {
			...
			const actions = [settings.imageShortcut && (settings.imageGeneration || settings.imageEditing) && {
				id: "image",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [items.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				ref: anchor,
		...
		const zh = {
			...
			imageBrowsing: "图片浏览",
			imageBrowsingHint: "在生成结果中查看原图、标注并继续编辑。",
			imageBrowsing_on: "增强",
		...
		const en = {
			...
			imageBrowsingHint: "View originals, annotate and continue editing generated images.",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				children: quotas.map((quota, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					children: [
						...
						preferenceSnapshot.quickQuotaMode !== "bar" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [`${percent(quota.remainingPercent)}%`, forecastMode && quota.forecast?.status === "ready" ? ` · ${forecastText(quota, t)}` : ""] }) : null
					]
			...
			ctx.slots.inject("conversation.input.left", () => ctx.slots.register({
				...
				inject: (sessionId) => ({
					...
					appendPrompt: (text, mode) => {
						const current = preference.getSnapshot();
						if (!(mode === "image" && current.imageShortcut && (current.imageGeneration || current.imageEditing))) throw new Error("Image input is disabled");
