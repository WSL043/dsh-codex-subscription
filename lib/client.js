window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function paintSketch(context, strokes, size = SKETCH_SIZE, transparent = false) {
			...
			for (const stroke of strokes) {
				...
				context.globalAlpha = stroke.brush === "marker" ? .28 : stroke.brush === "pencil" ? .65 : 1;
				...
				if (stroke.shape === "rectangle") {
					...
					for (let i = 1; i < stroke.points.length - 1; i++) {
						...
						if (context.quadraticCurveTo) context.quadraticCurveTo(point.x * size, point.y * size, (point.x + next.x) * size / 2, (point.y + next.y) * size / 2);
		...
		function paintSketchLayers(context, doc, cache, size = SKETCH_SIZE) {
			context.globalCompositeOperation = "source-over";
			context.globalAlpha = 1;
		...
		function SketchStudio({ open, onClose, attachSketch, enabled, t }) {
			...
			const [layersOpen, setLayersOpen] = (0, react.useState)(true), [busy, setBusy] = (0, react.useState)(false), [error, setError] = (0, react.useState)("");
			const paint = () => {
				if (canvas.current) paintSketchLayers(canvas.current.getContext("2d"), doc.current, cache.current);
			};
			const schedule = () => {
			...
			const move = (event) => {
				...
				for (const sample of events.length ? [...events, native] : [native]) {
					const point = sketchPoint(sample.clientX, sample.clientY, rect);
					if (!point) continue;
					...
					if (gesture.eraseStroke) {
						...
						layer.strokes = layer.strokes.filter((stroke) => !Array.from({ length: steps }, (_, i) => ({
							x: previous.x + (point.x - previous.x) * (i + 1) / steps,
							y: previous.y + (point.y - previous.y) * (i + 1) / steps
						})).some((p) => strokeHit(stroke, p, width / 2)));
					} else {
			...
			const attach = async () => {
				...
				try {
					paint();
					await attachSketch(await new Promise((resolve, reject) => canvas.current.toBlob((blob) => blob ? resolve(blob) : reject(Error("PNG")), "image/png")));
					onClose();
				} catch {
				...
				children: [
						...
						children: [
							tool === "pen" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
								...
								children: [
									...
									"pencil",
									"marker"
								].map((v) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: v,
									children: t(`sketchBrush_${v}`)
								}, v))
							}) : tool === "eraser" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
								"aria-label": t("sketchEraserMode"),
								value: eraser,
								onChange: (e) => setEraser(e.target.value),
								disabled: busy,
								children: ["pixel", "stroke"].map((v) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: v,
									children: t(`sketchErase_${v}`)
								}, v))
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(`sketchTool_${tool}`) }),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: t("sketchLayers")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: busy || !current.strokes.length,
								"aria-label": t("sketchClearLayer"),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							disabled: busy || !enabled || !doc.current.layers.some((l) => l.visible && l.strokes.length),
							onClick: () => void attach(),
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WorkspaceIcon, {
								name: "check",
								size: 28
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: error || t("sketchLayerHint")
					})
				]
			});
		}
...
`;
		...
		function SketchWorkspace({ preference, attachSketch, appendPrompt, registerOpen, t }) {
			...
			const [mode, setMode] = (0, react.useState)(null), [brief, setBrief] = (0, react.useState)(""), [template, setTemplate] = (0, react.useState)("templatePoster"), [busy, setBusy] = (0, react.useState)(false), [error, setError] = (0, react.useState)("");
			const dialog = (0, react.useRef)(null), opener = (0, react.useRef)(null);
			(0, react.useEffect)(() => registerOpen((nextMode = "sketch", source = document.activeElement) => {
				opener.current = source;
				setError("");
				if (nextMode === "image") {
					try {
						appendPrompt(t("imageInlinePrompt"), "image");
					} catch {
						setError(t("imageDraftFailed"));
					}
					return;
				}
				setMode(nextMode);
			...
			(0, react.useEffect)(() => {
				if (mode === "template") dialog.current?.showModal();
			}, [mode]);
			const close = () => {
				setMode(null);
			...
			const confirm = async () => {
				if (busy || !settings.imageTemplates || !settings.imageGeneration) return;
				setBusy(true);
				setError("");
				try {
					await appendPrompt(`${t(`${template}Prompt`)}\n\n${brief.trim()}`, "template");
					close();
				} catch {
					setError(t("imageDraftFailed"));
				} finally {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SketchStudio, {
					open: mode === "sketch",
					onClose: close,
					attachSketch,
				...
				mode === "template" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dialog", {
					ref: dialog,
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: t("imageTemplate") }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "codexSketchHint",
							children: error || t("imageDraftHint")
						}),
				...
				error && mode === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					role: "alert",
					children: error
				}) : null
			] });
...
`;
		...
		*/
		...
		function CodexComposerQuota({ preference, rpc, t, directory }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				children: quotas.map((quota, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: "codexQuotaCompactWindow",
					children: [
						preferenceSnapshot.quickQuotaMode === "bar" && quotas.length === 1 && Math.abs(quota.windowSeconds - 604800) < 60 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: shortWindow(quota.windowSeconds, t) }),
						...
						preferenceSnapshot.quickQuotaMode !== "bar" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: forecastMode ? forecastText(quota, t) : `${percent(quota.remainingPercent)}%` }) : null
					]
				...
				children: [warning ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: "codexQuotaWarning",
					role: "status",
					children: t("quotaThresholdReached")
				}) : null, quotas.map((quota, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					] }), forecastMode ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: forecastText(quota, t) }) : null]
				}, `${quota.windowSeconds}-${index}`))]
			}), document.body) : null] });
		}
		...
		*/
		...
		function UsageCard({ rpc, t, signedIn, resetKey, preference }) {
			...
			const warning = error === void 0 ? quotaWarning(visibleUsage, preferenceSnapshot.quotaAlerts, now, preferenceSnapshot) : void 0;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						hidden: tab !== "advanced",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreferencesCard, {
							preference,
							t,
							section: "advanced"
