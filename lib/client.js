		...
		*/
		...
		function ComposerImagePreviews(props) {
			...
			(0, react.useEffect)(() => {
				...
				const leave = (event) => {
					if (files(event) && (--depth.current <= 0 || !event.relatedTarget)) reset();
				};
				const drop = (event) => {
					if (files(event)) {
						event.preventDefault();
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [dragging ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "codexImageDrop",
				role: "status",
				children: t(canAcceptDrop ? "imageDropHere" : "imageDropUnavailable")
			}) : null, attachments.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "codexDraftImages",
				children: attachments.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: "codexDraftImage",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "codexImageThumb",
						"aria-label": `${t("imagePreview")} ${item.file.name}`,
						onClick: (event) => openPreview(props, {
							id: item.id,
							src: item.previewUrl,
							name: item.file.name,
							width: item.width,
						...
						type: "button",
						className: "codexImageRemove",
						"aria-label": `${t("imageRemoveDraft")} ${item.file.name}`,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: state === "idle" ? t("imageEditShort") : label
					})
				]
			});
		}
		...
		*/
		...
		function forecastText(quota, t) {
			...
			if (forecast?.status === "calibrating") return t({
				...
				"changing-pace": "forecastChanging",
				stale: "forecastStale"
			}[forecast.reason] ?? "quickQuotaForecastCalibrating");
