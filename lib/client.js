window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const IMAGE_REFERENCE_ROLES = Object.freeze([
			...
			{
				id: "subject",
				label: "imageRoleSubject",
				prompt: "imageRoleSubjectPrompt"
			},
			{
				id: "style",
				label: "imageRoleStyle",
				prompt: "imageRoleStylePrompt"
			},
			{
				id: "composition",
				label: "imageRoleComposition",
				prompt: "imageRoleCompositionPrompt"
			}
		]);
		function buildImageEditDraft({ prompt = "", annotations = [], referenceRole = "edit", translate }) {
			...
			const request = role?.prompt === void 0 ? base : translate(role.prompt) + "\n" + base;
		...
		const zh = {
			...
			imageReferenceRole: "图片用途",
			imageRoleEdit: "直接编辑",
			imageRoleSubject: "主体参考",
			imageRoleStyle: "风格参考",
			imageRoleComposition: "构图参考",
			imageRoleSubjectPrompt: "将这张图片作为主体参考。",
			imageRoleStylePrompt: "将这张图片作为风格参考。",
			imageRoleCompositionPrompt: "将这张图片作为构图参考。"
		};
		const en = {
			nav: "Codex",
			...
			imageReferenceRole: "Image role",
			imageRoleEdit: "Edit directly",
			imageRoleSubject: "Subject reference",
			imageRoleStyle: "Style reference",
			imageRoleComposition: "Composition reference",
...
`;
		...
		function CodexGeneratedImage({ attachment, loadImage, attachForEdit, t }) {
			...
			const [referenceRole, setReferenceRole] = (0, react.useState)("edit");
			...
			const lightbox = !open || src === void 0 ? null : (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "codexGeneratedImageRole",
								role: "group",
								"aria-label": t("imageReferenceRole"),
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("imageReferenceRole") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: IMAGE_REFERENCE_ROLES.map((role) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: referenceRole === role.id ? "is-active" : "",
									"aria-pressed": referenceRole === role.id,
