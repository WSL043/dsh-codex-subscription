export const zh = {
  ...
  imageWorkspaceMenu: '图片工具', imageCreateAction: '生成或编辑图片', imageCreateGroup: '创作', imageHistoryGroup: '当前会话', imageGalleryEmpty: '这个会话还没有生成图片。生成后可以在这里查看、比较或选择原图继续编辑。',
  ...
  imageGallery: '会话图片库', imageCompare: '图片对比', imageGalleryHint: '当前会话最近 100 张生成图片。选择最多 5 张作为一次编辑的参考；对比请选择两张。', imageCompareAction: '并排对比', imageSelectedEdit: '附加所选图片', imageGalleryFailed: '无法加载或附加图片，请重试。',
  imageSettings: '图片工作台', imageGeneration: '生成新图片', imageEditing: '参考图编辑', imageViewer: '增强图片查看器', imageAnnotations: '图片标注', imageSketch: '草图画板', imageTemplates: '创作模板',
  imageSettingsHint: '关闭功能保留历史图片。草图作为参考图发送，需要开启参考图编辑；标注需要增强查看器。',
  sketch: '草图', sketchTitle: '画出你的想法', sketchAttach: '附加草图', sketchCancel: '取消', sketchUndo: '撤销', sketchRedo: '重做', sketchClear: '清空', sketchEraser: '橡皮', sketchPen: '画笔', sketchColor: '颜色', sketchWidth: '笔刷粗细', sketchFailed: '无法附加草图，请保留画板后重试。', sketchHint: '确认只会附加图片，不会自动生成。发送时说明你想要的风格与细节。',
  imageTemplate: '创作模板', templatePoster: '海报', templateProduct: '商品图', templateIcon: '图标', templatePrompt: '创作说明', templateAdd: '填入草稿',
  ...
  quotaAlerts: '额度提醒', quotaAlerts_off: '关闭', quotaAlerts_important: '剩余 20%', quotaAlerts_early: '提前提醒', quotaAlertsHint: '提前提醒：短周期剩余不超过 50%，其他周期不超过 20%。仅展示新鲜数据，不弹窗打断。', quotaWarning: '{window}额度剩余 {value}%，请留意用量与重置时间。',
  ...
  settingsTab_account: '账号与额度', settingsTab_display: '使用偏好', settingsTab_advanced: '高级与诊断',
...
export const en = {
  ...
  imageWorkspaceMenu: 'Image tools', imageCreateAction: 'Generate or edit an image', imageCreateGroup: 'Create', imageHistoryGroup: 'This conversation', imageGalleryEmpty: 'No generated images in this conversation yet. After generating an image, return here to view, compare or select references for editing.',
  ...
  imageGallery: 'Session image library', imageCompare: 'Image comparison', imageGalleryHint: 'Latest 100 generated images in this session. Select up to 5 references for one edit, or two for comparison.', imageCompareAction: 'Compare side by side', imageSelectedEdit: 'Attach selected images', imageGalleryFailed: 'Could not load or attach images. Please try again.',
  imageSettings: 'Image workspace', imageGeneration: 'Generate new images', imageEditing: 'Reference image editing', imageViewer: 'Enhanced image viewer', imageAnnotations: 'Image annotations', imageSketch: 'Sketch canvas', imageTemplates: 'Creative templates',
  ...
  sketch: 'Sketch', sketchTitle: 'Draw your idea', sketchAttach: 'Attach sketch', sketchCancel: 'Cancel', sketchUndo: 'Undo', sketchRedo: 'Redo', sketchClear: 'Clear', sketchEraser: 'Eraser', sketchPen: 'Pen', sketchColor: 'Color', sketchWidth: 'Brush width', sketchFailed: 'Could not attach the sketch. Keep the canvas and try again.', sketchHint: 'Confirming only attaches an image. Describe the style and details before sending.',
  imageTemplate: 'Creative template', templatePoster: 'Poster', templateProduct: 'Product image', templateIcon: 'Icon', templatePrompt: 'Creative brief', templateAdd: 'Add to draft',
  ...
  quotaAlerts: 'Usage alerts', quotaAlerts_off: 'Off', quotaAlerts_important: '20% remaining', quotaAlerts_early: 'Early warning', quotaAlertsHint: 'Early warning: 50% remaining for short windows, 20% for other windows. Fresh data only, without interrupting popups.', quotaWarning: '{window}: {value}% remaining. Check usage and reset time.',
  ...
  settingsTab_account: 'Account & usage', settingsTab_display: 'Preferences', settingsTab_advanced: 'Advanced',
