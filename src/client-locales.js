export const zh = {
  ...
  runtimeFailed: '操作未完成。请刷新状态后重试；详细原因可在 DSH 插件管理中查看。', runtimeBuildBlocked: 'DSH 拦截了依赖安装脚本。请在官方插件管理中审核后再安装。', runtimeCancelled: '安装已取消，可重新安装。',
  ...
  autoQuotaRetry: '额度重置后自动重试', autoQuotaRetryHint: '选择开启后，将等待已确认的短时额度重置；对话会显示等待原因且可停止，等待期间切换账号会立即重试。',
...
export const en = {
  ...
  runtimeFailed: 'The operation did not complete. Refresh and retry; see DSH plugin management for details.', runtimeBuildBlocked: 'DSH blocked dependency build scripts. Review them in the official plugin manager before installing.', runtimeCancelled: 'Installation cancelled. You can try again.',
  ...
  autoQuotaRetry: 'Retry after quota reset', autoQuotaRetryHint: 'Opt in to wait for confirmed short quota resets. The turn shows why it is waiting and can be stopped; switching accounts retries immediately.',
